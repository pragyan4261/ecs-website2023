...
const Footer = () => {
  return (
    <div className='pt-5 mt-72 bg-gradient-to-b from-blue-800 to-blue-950 h-[25rem] flex flex-col justify-center items-center space-y-5 text-white sm:space-y-3 sm:pt-0 sm:h-[22rem]'>
