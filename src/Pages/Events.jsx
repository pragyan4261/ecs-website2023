...
const Events = () => {
    const events = [
        { reference: 'event1', order: 'flex-row', name: 'Spectrum', desc: 'Vorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam eu turpis molestie, dictum est a, mattis tellus. Sed dignissim, metus nec fringilla accumsan, risus sem sollicitudin lacus, ut interdum tellus elit sed risus. Maecenas eget condimentum velit, sit amet feugiat lectus. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.', photo: 'https://res.cloudinary.com/dhry5xscm/image/upload/v1693860527/ecs-website/cardimg_m5t0pi.png' },
        { reference: 'event2', order: 'flex-row-reverse', name: 'Spectrum', desc: 'Vorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam eu turpis molestie, dictum est a, mattis tellus. Sed dignissim, metus nec fringilla accumsan, risus sem sollicitudin lacus, ut interdum tellus elit sed risus. Maecenas eget condimentum velit, sit amet feugiat lectus. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.', photo: 'https://res.cloudinary.com/dhry5xscm/image/upload/v1693860527/ecs-website/cardimg_m5t0pi.png' },
        { reference: 'event3', order: 'flex-row', name: 'Spectrum', desc: 'Vorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam eu turpis molestie, dictum est a, mattis tellus. Sed dignissim, metus nec fringilla accumsan, risus sem sollicitudin lacus, ut interdum tellus elit sed risus. Maecenas eget condimentum velit, sit amet feugiat lectus. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.', photo: 'https://res.cloudinary.com/dhry5xscm/image/upload/v1693860527/ecs-website/cardimg_m5t0pi.png' },
        { reference: 'event4', order: 'flex-row-reverse', name: 'Spectrum', desc: 'Vorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam eu turpis molestie, dictum est a, mattis tellus. Sed dignissim, metus nec fringilla accumsan, risus sem sollicitudin lacus, ut interdum tellus elit sed risus. Maecenas eget condimentum velit, sit amet feugiat lectus. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.', photo: 'https://res.cloudinary.com/dhry5xscm/image/upload/v1693860527/ecs-website/cardimg_m5t0pi.png' }
    ];
    return (
        <div>
